            ...
            <div class="section banner">
                <div class="tiva-slideshow-wrapper">
                    <div id="tiva-slideshow" class="nivoSlider">
                        ...
                        <a href="#">
                            <img class="img-responsive" src="{{asset('/uploads/images/banners'). '/' . $banner->photo}}" title="#caption1" alt="Slideshow image">
                        </a>
                        @endforeach
                    </div>
                </div>
                                            ...
                                            <div class="block-content">
                                                <div class="policy-item">
                                                    <div class="policy-content iconpolicy1">
                                                        <img src="{{asset('Frontend/img/home/home1-policy.png')}}" alt="img">
                                            ...
                                            <div class="block-content">
                                                <div class="policy-item">
                                                    <div class="policy-content iconpolicy2">
                                                        <img src="{{asset('Frontend/img/home/home1-policy2.png')}}" alt="img">
                                            ...
                                            <div class="block-content">
                                                <div class="policy-item">
                                                    <div class="policy-content iconpolicy3">
                                                        <img src="{{asset('Frontend/img/home/home1-policy3.png')}}" alt="img">
                                            ...
                                            <div class="categoriestab-right col-lg-3 align-items-start d-flex flex-column col-md-3 flex-3">
                                                ...
                                                <div class="cate-child-vertical">
                                                    <ul class="d-flex align-items-start flex-column">
                                                        ...
                                                        <li>
                                                            <a href="product-grid-sidebar-left.html">{{$cat_info->title}}</a>
                                                        </li>
                                                        @endforeach
                                                        ...
                                                        @else
                                                        <li>
                                                            <a href="product-grid-sidebar-left.html">No Categories</a>
                                                        </li>
                                                        @endif
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="groupproductlist">
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="flex-4 col-lg-4 flex-4">
                                                    ...
                                                    <div class="content-text">
                                                        <p> Here is the Block of Featured Products.
                                                        </p>
                                                        <div>
                                                            <a href="product-grid-sidebar-left.html"> View all product </a>
                                                        </div>
                                        ...
                                        <div class="item-post">
                                            <div class="thumbnail-img">
                                                <a href="blog-detail.html">
                                                    <img src="{{asset('/uploads/images/posts'). '/' . $post->photo}}" alt="img">
                                                </a>
                                            </div>
                                                ...
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            {{$cat_info->title}}
                                                            <img class="img-fluid" src="{{asset('/uploads/images/categories'). '/' . $cat_info->photo}}" alt="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                @endforeach
