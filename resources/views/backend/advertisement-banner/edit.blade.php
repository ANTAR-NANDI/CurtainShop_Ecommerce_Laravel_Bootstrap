...
<div class="card">
  <h5 class="card-header">Edit Advertisement Banner</h5>
  <div class="card-body">
    <form method="post" action="{{route('advertisement-banner.update',$banner->id)}}" enctype="multipart/form-data">
      @csrf
      @method('PATCH')
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          ...
          <img width="100px" height="100px" src="{{asset('/uploads/images/advertisement-banners'). '/' . $banner->photo}}">
          @endif
        </div>
